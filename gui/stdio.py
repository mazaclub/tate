...
_ = lambda x:x
#from i18n import _
from tate.wallet import WalletStorage, Wallet
from tate.util import format_satoshis, set_verbosity
from tate.bitcoin import is_valid
from tate.network import filter_protocol
...
class ElectrumGui:
    ...
    def network_dialog(self):
        print("use 'tate setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'tate setconfig' to change your settings")
        return True
