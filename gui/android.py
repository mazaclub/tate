...
from tate import SimpleConfig, Wallet, WalletStorage, format_satoshis, mnemonic_encode, mnemonic_decode
...
def pay_to(recipient, amount, fee, label):
    ...
    droid.dialogCreateSpinnerProgress("Tate", "signing transaction...")
    droid.dialogShow()
        ...
        if event["name"]=="click":
            ...
            if out == 'contacts':
                ...
                if receive_addr:
                    ...
                    if amount:
                        receive_addr = 'mazacoin:%s?amount=%s'%(receive_addr, amount)
...
class ElectrumGui:
    ...
    def restore_wallet(self):
        ...
        droid.dialogCreateSpinnerProgress("Tate", msg)
        droid.dialogShow()
