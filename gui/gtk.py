...
from tate.util import print_error, InvalidPassword
from tate.bitcoin import is_valid, COIN
from tate.wallet import NotEnoughFunds
...
from tate.util import format_satoshis, parse_URI
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        from tate.util import StoreDict
